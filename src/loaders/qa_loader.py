...
class QALoader(BaseLoader):
    """
    For datasets where each row has a question-like field and an answer-like field.
    - prompt = question
    - gold   = answer (kept as-is; no parsing/normalization here)
    - meta   = selected auxiliary fields
    """
...
LoaderFactory.register(TASK_MATH_NUMERIC, QALoader)